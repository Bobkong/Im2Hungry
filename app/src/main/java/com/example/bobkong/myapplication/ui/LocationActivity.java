...
//        GeocodeQuery geocodeQuery = new GeocodeQuery(search_info, null);
    ...
    private void choose_click(){
        ...
        if(SelectedPoi != null){
            ...
            intent.putExtra("select_location", title);
            intent.putExtra("select_lat",SelectedPoi.getLatLonPoint().getLatitude());
            intent.putExtra("select_lng",SelectedPoi.getLatLonPoint().getLongitude());
